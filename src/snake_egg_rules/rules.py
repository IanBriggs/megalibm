...
raw_rules = [
    ...
    ["sin-PI/6",   sin(div(CONST_PI(), 6)),      div(1, 2)],
    ["sin-PI/4",   sin(div(CONST_PI(), 4)),      div(sqrt(2), 2)],
    ["sin-PI/3",   sin(div(CONST_PI(), 3)),      div(sqrt(3), 2)],
    ["sin-PI/2",   sin(div(CONST_PI(), 2)),      1],
    ["sin-PI",     sin(CONST_PI()),            0],
    ["sin-+PI",    sin(add(x, CONST_PI())),      neg(sin(x))],
    ["sin-+PI/2",  sin(add(x, div(CONST_PI(), 2))), cos(x)],
    ["cos-PI/6",   cos(div(CONST_PI(), 6)),      div(sqrt(3), 2)],
    ["cos-PI/4",   cos(div(CONST_PI(), 4)),      div(sqrt(2), 2)],
    ["cos-PI/3",   cos(div(CONST_PI(), 3)),      div(1, 2)],
    ["cos-PI/2",   cos(div(CONST_PI(), 2)),      0],
    ["cos-PI",     cos(CONST_PI()),            neg(1)],
    ["cos-+PI",    cos(add(x, CONST_PI())),      neg(cos(x))],
    ["cos-+PI/2",  cos(add(x, div(CONST_PI(), 2))),   neg(sin(x))],
    ["tan-PI/6",   tan(div(CONST_PI(), 6)),      div(1, sqrt(3))],
    ["tan-PI/4",   tan(div(CONST_PI(), 4)),      1],
    ["tan-PI/3",   tan(div(CONST_PI(), 3)),      sqrt(3)],
    ["tan-PI",     tan(CONST_PI()),            0],
    ["tan-+PI",    tan(add(x, CONST_PI())),      tan(x)],
    #div ["tan-+PI/2",  tan(add(x, div(CONST_PI(), 2))), div(-1, tan(x))],
    ...
    ["atan-tan",   atan(tan(x)),       remainder(x, CONST_PI())],
    #div ["asin-sin",   asin(sin(x)),       sub(fabs(remainder(add(x, div(CONST_PI(), 2)), mul(2, CONST_PI()))), div(CONST_PI(), 2))],
    ["acos-cos",   acos(cos(x)),       fabs(remainder(x, mul(2, CONST_PI())))],
    ...
    #div ["asin-acos",  asin(x),             sub(div(CONST_PI(), 2), acos(x))],
    #div ["acos-asin",  acos(x),             sub(div(CONST_PI(), 2), asin(x))],
    ["asin-neg",   asin(neg(x)),         neg(asin(x))],
    ["acos-neg",   acos(neg(x)),         sub(CONST_PI(), acos(x))],
    ...
    ["revsin-+PI/2",         cos(x),      sin(add(x, div(CONST_PI(), 2)))                                ],
...
#     ["tan-PI",                  tan(CONST_PI()),                                                0],
#     ["tan-+PI",                 tan(add(x, CONST_PI())),                                        tan(x)],
#     ["tan-+PI/2",               tan(add(x, div(CONST_PI(), 2))),                                div(-1, tan(x))],
...
#     ["tan-atan",                tan(atan(x)),                                             x],
#     ["atan-tan",                atan(tan(x)),                                             remainder(x, CONST_PI())],
#     ["asin-sin",                asin(sin(x)),                                             sub(fabs(remainder(add(x, div(CONST_PI(), 2)), mul(2, CONST_PI()))), div(CONST_PI(), 2))],
#     ["acos-cos",                acos(cos(x)),                                             fabs(remainder(x, mul(2, CONST_PI())))],
#     ["atan-tan-s",              atan(tan(x)),                                             x],
#     ["asin-sin-s",              asin(sin(x)),                                             x],
#     ["acos-cos-s",              acos(cos(x)),                                             x],
...
#     ["asin-acos",               asin(x),                                                  sub(div(CONST_PI(), 2), acos(x))],
#     ["acos-asin",               acos(x),                                                  sub(div(CONST_PI(), 2), asin(x))],
#     ["asin-neg",                asin(neg(x)),                                             neg(asin(x))],
#     ["acos-neg",                acos(neg(x)),                                             sub(CONST_PI(), acos(x))],
#     ["atan-neg",                atan(neg(x)),                                             neg(atan(x))],
