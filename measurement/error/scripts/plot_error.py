...
def main(argv):
    ...
    for fname in fnames:
        ...
        base_func = fname[0:-len("_error_n.json")]

        print("  Plotting 1/3")
        plot_error("{} Absolute Error Domain {}".format(base_func, input_typ),
                   data["regions"],
                   ref_data["abs_max_errors"],
                   libm_data["abs_max_errors"],
                   [gen_data["abs_max_errors"] for gen_data in gen_datas])
        print("  Plotting 2/3")
        plot_error("{} Relative Error Domain {}".format(base_func, input_typ),
                   data["regions"],
                   ...
                   True)
        print("  Plotting 3/3")
        plot_abs_vs_rel("{} Absolute vs Relative Error Domain {}".format(base_func, input_typ),
