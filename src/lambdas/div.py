...
class Div(types.Transform):
    ...
    def replace_lambda(self, search, replace):
        ...
        return Div(new_num_node, new_den_node)
    ...
    def generate(self, numeric_type=FP64):
        ...
        y_name = self.gensym("div_out")

        div_block = lego_blocks.LegoFPCore(
        ...
        return num_so_far + den_so_far + [div_block]